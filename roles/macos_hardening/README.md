...
- `macos_file_sharing_enabled`
  - Default: `False`
  - Description: Desired state for File Sharing (SMB) service when managed.
  - Type: bool
  - Required: no
- `macos_file_sharing_manage`
  - Default: `False`
  - Description: Whether this role manages File Sharing (SMB service).
  - Type: bool
  - Required: no
